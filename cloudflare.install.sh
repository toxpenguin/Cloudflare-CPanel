...
if [ "$LOCAL_FILE_PATH" = "" ]; then
    ...
    DOWNLOAD_URL="https://github.com/toxpenguin/CloudFlare-CPanel/archive/v$LATEST_VERSION.tar.gz"
...
/usr/local/cpanel/scripts/install_plugin --theme jupiter $SOURCE_DIR/installers/cloudflare_simple.tar.bz2
